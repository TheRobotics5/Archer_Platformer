...
if(lightning_powered == 0)
{
	...
	if(gold_powered == 0)
	{
		...
		if(facing == 2)
		{
			...
			/// @DnDHash : 2C162D4C
			/// @DnDParent : 6950CA3E
			/// @DnDArgument : "code" "arrow = instance_create_layer(x, y-66, "Projectiles", Player_arrow);$(13_10)arrow.speed = 12;$(13_10)arrow.image_angle = 90;$(13_10)arrow.direction = 90;"
			arrow = instance_create_layer(x, y-66, "Projectiles", Player_arrow);
			arrow.speed = 12;
...
if(lightning_powered == 1)
{
	...
	if(facing == 2)
	{
		...
		/// @DnDHash : 0033C41B
		/// @DnDParent : 5D8DE8A4
		/// @DnDArgument : "code" "arrow = instance_create_layer(x, y-66, "Projectiles", Player_arrow);$(13_10)arrow.speed = 10;$(13_10)arrow.direction = 90;"
		arrow = instance_create_layer(x, y-66, "Projectiles", Player_arrow);
		arrow.speed = 10;
		arrow.direction = 90;
	}
...
if(gold_powered == 1)
{
	...
	if(facing == 2)
	{
		...
		/// @DnDHash : 22E62678
		/// @DnDParent : 4F32D15E
		/// @DnDArgument : "code" "Hook = instance_create_layer(x, y-66, "Projectiles", Player_arrow);$(13_10)Hook.speed = 10;$(13_10)Hook.image_angle = 90;$(13_10)Hook.direction = 90;"
		Hook = instance_create_layer(x, y-66, "Projectiles", Player_arrow);
		Hook.speed = 10;
		Hook.image_angle = 90;
		Hook.direction = 90;
